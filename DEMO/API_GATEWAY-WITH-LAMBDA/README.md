#### Working with dynamo db and lambda function.


1. Go to dynamodb and select create table.(table name - locations)
2. Provide name to the table and select primarykey/partition key.
3. wait for status to become active

#### Create a lambda function in python 3.9 and paste the following code
...
- creaate an api gateway to connect to lambda function and integrate all three of them .
