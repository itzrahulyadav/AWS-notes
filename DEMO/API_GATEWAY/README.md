### Using API-gateway demo
### Look for  `Amazon API Gateway Lambda proxy integration`

1. Create a lambda function in python 3.10 and paste the following code
```
import json
import logging
...
-  Go to api gateway and select RESTAPI and click on build.
-  Paste the following code in the api code
  ```
{
  "swagger": "2.0",
  "info": {
...
### Create an api and 
1. click on actions and select create resource
2. give it a name and select get method.
3. select lambda function
4. select the resource created and select create function and select lambda function.
5. to create sub resources select the resource created and click on actions and select create resources and follow the exact steps we did previously.
